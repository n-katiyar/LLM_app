...
function transformBorderColor(color, opacity, key, direction) {
  const css = {};
  if (color) {
    if (Object.values(SpecialColorKey).includes(color)) {
...
function createHandleColor(property) {
  return (match, ctx) => {
    return colorResolver(`--un-${property}-color`, property)(match, ctx);
  };
}
...
function handleText([, s = "base"], { theme }) {
  ...
  const lineHeight = leading ? theme.leading?.[leading] || h.bracket.cssvar.global.rem(leading) : void 0;
  if (sizePairs) {
    return {
...
export { spaces as $, flex as A, gaps as B, grids as C, overflows as D, lineClamps as E, placeholders as F, positions as G, justifies as H, orders as I, alignments as J, placements as K, flexGridJustifiesAlignments as L, insets as M, floats as N, zIndexes as O, boxSizing as P, questionMark as Q, ringBase as R, rings as S, scrollSnapTypeBase as T, scrolls as U, boxShadowsBase as V, boxShadows as W, sizes as X, aspectRatio as Y, paddings as Z, margins as _, animations as a, notLastChildSelector as a0, varEmpty as a1, displays as a2, appearances as a3, cursors as a4, contains as a5, pointerEvents as a6, resizes as a7, userSelects as a8, whitespaces as a9, fonts as aA, tabSizes as aB, textIndents as aC, textStrokes as aD, textShadows as aE, fontVariantNumericBase as aF, fontVariantNumeric as aG, splitShorthand as aH, cssVariables as aI, cssProperty as aJ, viewTransition as aK, contentVisibility as aa, contents as ab, breaks as ac, textWraps as ad, textOverflows as ae, textTransforms as af, fontStyles as ag, fontSmoothings as ah, hyphens as ai, writingModes as aj, writingOrientations as ak, screenReadersAccess as al, isolations as am, objectPositions as an, backgroundBlendModes as ao, mixBlendModes as ap, dynamicViewportHeight as aq, accessibility as ar, svgUtilities as as, borderSpacingBase as at, tables as au, touchActionBase as av, touchActions as aw, transformBase as ax, transforms as ay, transitions as az, backgroundStyles as b, appearance as c, accents as d, carets as e, overscrolls as f, borderStyles as g, borders as h, imageRenderings as i, handlerBorderStyle as j, opacity as k, listStyle as l, bgColors as m, colorScheme as n, outline as o, columns as p, textDecorations as q, rules as r, scrollBehaviors as s, textAligns as t, divides as u, verticalAligns as v, willChange as w, filterBase as x, backdropFilterBase as y, filters as z };
