...
const { staticClasses, useClasses } = uikitReactUtils.createClasses("HvTableHeader", {
  root: {
  ...
  body: {
    ...
    ":where($sorted)": {
      backgroundColor: uikitStyles.theme.alpha("atmo1", 0.4)
    },
  ...
  resizing: { borderRight: `2px solid ${uikitStyles.theme.colors.primary_80}` },
  resizer: {
